// SPDX-Copyright (C) 2026 Dell Technologies
...
func NewVoucherPushService(cfg *VoucherConfig, store *VoucherTransmissionStore, resolver *VoucherDestinationResolver, client *VoucherPushClient) *VoucherPushService {
