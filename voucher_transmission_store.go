...
func (s *VoucherTransmissionStore) Init(ctx context.Context) error {
	...
	for _, col := range []string{"serial_number TEXT", "model_number TEXT"} {
		if err := s.addColumnIfMissing(ctx, "voucher_transmissions", col); err != nil {
			return err
		}
	}
...
func (s *VoucherTransmissionStore) addColumnIfMissing(ctx context.Context, table, columnDef string) error {
...
func (s *VoucherTransmissionStore) columnExists(ctx context.Context, table, column string) (bool, error) {
